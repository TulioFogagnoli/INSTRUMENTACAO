...
#define DHT11_PIN A5 // Pin sensor is connected to
DFRobot_DHT11 DHT;

int motor2Pin1 = 10; // pin 6 on L293D IC
int motor2Pin2 = 11; // pin 7 on L293D IC
int motor2EnablePin = 13; // pin 10 on L293D IC

int motor1Pin1 = 9; // pin 4 on L293D IC
int motor1Pin2 = 8; // pin 5 on L293D IC
int motor1EnablePin = 12; // pin 9 on L293D IC
...
if(timer>400){
 ...
 lcd.print(temp);        //send distance to MIT App
 lcd.print(";");
 lcd.print(hum);         //send distance to MIT App
 lcd.print(";");
 lcd.setCursor(0, 1);
 lcd.print(distanceFwd); //send distance to MIT App 
 lcd.println(";");    
 timer=0; 
}
